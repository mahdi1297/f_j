export const LoginToAccountAsUser = "ورود به حساب به عنوان کاربر";
export const LoginToAccountAsCompony = "ورو به حساب به عنوان شرکت";
export const LoginAsCompony = "ورود به حساب عنوان شرکت";
export const LoginAsUser = "ورود به عنوان کاربر";
export const DontHaveAccount = "هنوز حساب ندارید؟";
export const HaveAccount = "حساب کاربری دارید؟";
export const RememberPassword = "به خاطر سبردن";
export const ForgotPassword = "فراموشی رمز عبور?";
export const RegisterIn = "ثبت نام";
export const RedirectToLogin = "در حال هدایت به صفحه ورود";
export const RedirectToHome = "در حال هدایت به خانه";
export const SignIn = " ورود";
export const CreateAccount = "ساخت حساب";
export const LoginToAccount = "ورود به حساب";
export const EnterToAccountBy = "ورود به حساب با";
export const SEND_RESUME = 'ارسال رزومه'
export const EXPERIENCE_LEVEL = 'سطح تجربه'
export const SALARY_LEVEL = 'میانگین حقوق'
export const WORK_LEVEL = 'سطح کار'
export const AGREEMENT_TYPE = 'نوع قرارداد'
export const Lurem =
